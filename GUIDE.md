...
| **Technician Performance** | "How is workload distributed among staff?" | Per-technician: open, closed, aged, breach rate — with a Window Start/End control (M2/N2) to slice any period (week, sprint, quarter) |
