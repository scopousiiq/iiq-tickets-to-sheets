...
function setupInstructionsSheet(ss) {
  ...
  const content = [
    ...
    ['═══════════════════════════════════════════════════════════════════════════════'],
    [''],
    ['Set up time-driven triggers in Apps Script (Extensions > Apps Script > Triggers):'],
    [''],
    ...
    ['| triggerDataContinue       | Every 10 min     | Initial load only (disable after) |'],
    [''],
    ...
    ['  • Open Ticket Refresh - Update open tickets + recently closed (primary refresh)'],
